...
public class Main {
	...
	protected static List<Integer> results2 = new ArrayList<Integer>();
	protected static List<Integer> results1 = new ArrayList<Integer>();
	protected static List<Integer> temp = new ArrayList<Integer>();
	...
	public static void newCriterion() {
		...
		while (criteria.isEmpty()) {
			System.out
					.println("There are currently no criteria to consider. We have to have at least one (i.e. \"Fame\").\n>");
	...
	public static void calculateOptions() {
		...
		temp.clear();
		// System.out.println("Results for " + options.get(0) + ": " + results1);
		...
		temp.clear();
		// System.out.println("Results for " + options.get(1) + ": " + results2);
...
// HashMap<String, Object> scoreToWeight = new HashMap<String,
// Object>();
//
// for (Collection collection : multimap.asMap().values()) {
//
// // Convert multimap to an array of integers
// Integer[] array = (Integer[]) (collection
